...
public class Mapa4 extends Mapa {
	...
	public Mapa4(Jogador jogador, Monstro monstro) {
		...
		this.arestas[0][0][0][1] = this.arestas[0][1][0][2] = this.arestas[0][2][0][3] = this.arestas[0][3][0][4] = true;
		this.arestas[1][0][1][1] = this.arestas[1][1][1][2] = this.arestas[1][2][1][3] = this.arestas[1][3][1][4] = true;
		this.arestas[2][0][2][1] = this.arestas[2][3][2][4] = true;
		this.arestas[3][0][3][1] = true;
		this.arestas[4][0][4][1] = this.arestas[4][1][4][2] = this.arestas[4][3][4][4] = true;
		
		this.arestas[3][0][4][0] = true;
		this.arestas[1][1][2][1] = this.arestas[1][2][1][3] = true;
		this.arestas[1][2][2][2] = this.arestas[2][3][2][4] = true;
		this.arestas[2][3][3][3] = true;
		this.arestas[0][4][1][4] = this.arestas[1][4][2][4] = this.arestas[2][4][3][4] = this.arestas[3][4][4][4] = true;
		
		//Inserir um mapa aqui
		jogador.setPos(0.6,0.6);
		jogador.setAngulo(270);
		monstro.setPos(1.6,0.6);
